    ...
    <div class="filterable">
        ...
        <div class="panel">
            ...
            <div class="filterable-export">
                <div>
                    ...
                    <button class="vue-btn vue-btn-danger" @click="resetFilter"
                            v-if="this.appliedFilters.length>0">Reset
                    </button>
                    <button class="vue-btn vue-btn-primary" @click="applyFilter">Apply Filter</button>
                </div>
                <div>
                    <span>Order By</span>
            ...
            <div class="panel-footer">
                ...
                <div>
                    <button class="vue-btn vue-btn-secondary" :disabled="!collection.prev_page_url || loading" @click="prevPage"> &laquo;
                        Prev
                    </button>
                    <button class="vue-btn  vue-btn-secondary" :disabled="!collection.next_page_url || loading" @click="nextPage">Next
                        &raquo;
                    </button>
                </div>
            </div>
        ...
        methods: {
            ...
            availableOperators() {
                return [
                    ...
                    {title: 'End With', name: 'ends_with', parent: ['string'], component: 'single'},
